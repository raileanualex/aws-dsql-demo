...
// service/get-current-score/Handler.ts
var Handler_exports = {};
...
// service/get-current-score/Usecase.ts
var GetCurrentScore = class {
  constructor(getCurrentScoreRepository) {
    this.getCurrentScoreRepository = getCurrentScoreRepository;
  }
  async run(payload, context) {
    console.log(payload);
    console.log(context);
    return this.getCurrentScoreRepository.sayHelloWorld();
  }
};

// service/get-current-score/Adapter.ts
var import_lambda_handlers = __toESM(require_lambda_handlers());
var GetCurrentScoreAdapter = class {
  constructor(usecase) {
...
// service/get-current-score/Repository.ts
var GetCurrentScoreRepository = class {
  sayHelloWorld() {
    return "get current score";
  }
};

// service/get-current-score/Handler.ts
async function initialize() {
  const helloWorldRepository = new GetCurrentScoreRepository();
  const usecase = new GetCurrentScore(
    helloWorldRepository
  );
  return new GetCurrentScoreAdapter(usecase);
}
var adapter;
